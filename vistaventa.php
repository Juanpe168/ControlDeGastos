							...
							<div class="row segunda">
								<div class="col-lg-12 col-md-12" >
										...
										<div class="col-md-12 col-lg-12 totheleft" >
											<div class="form-group">
												...
												<label>Categoria</label>
													<select id="categoria" class="form-control form-control-sm" style="width:100%;" onchange="visualizarVentas();" placeholder="Categoria de articulo" >
										...
										<div class="col-md-12 col-lg-12" class="form-group" >								
												<label>Nombre de Cliente</label>				
												 <div class="form-group" style="width:100%;">
													<input type="text" id="nomCliente" class="form-control" onkeyup="visualizarVentas();" placeholder="Nombre de Cliente">
										...
										<div class="col-md-12 col-lg-12" class="form-group" >
												...
												<div class="form-group" style="width:100%;">
													<input type="text" id="nomProducto" class="form-control" onkeyup="visualizarVentas();" placeholder="Productos">
										...
										<div class="col-md-12 col-lg-12" class="form-group" >
												<label>Fecha</label>
												<div class="form-group" style="width:100%;">
													<input type="date" name="data" class="form-control" placeholder="Fecha">
												</div>
										</div>
										...
										<div class="col-md-12 col-lg-12" class="form-group" >
												<label>Importe</label>
												<div class="form-group" style="width:100%;">
													<input type="text" class="form-control" placeholder="Importe" id="nomImporte" onkeyup="visualizarVentas();">
										...
										<div class="col-md-12 col-lg-12" class="form-group" >
												<label>Tienda</label>
												<div class="form-group" style="width:100%;">
													<input type="text"  class="form-control" placeholder="Tienda" onkeyup="visualizarVentas();" id="nomTienda">
										...
										<div class="col-md-12 col-lg-12" class="form-group" >
											...
											<?php  include "usuarios.php";?>
												...
												<label>Usuario</label>						
												<select class="form-control form-control-sm" style="width:100%;" placeholder="Categoria de articulo" id="nomUser" onchange="visualizarVentas();" >
													<option value="0">Seleccionar opcion</option>
													<?php
										...
										<div class="col-md-12 col-lg-12" class="form-group" >
										<button type="button" class="btn btn-success" style="width:100%;" onclick="visualizarVentas();">Visualizar Datos</button>
